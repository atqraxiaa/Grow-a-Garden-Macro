...
MyGui.Add("Button", "x20 y135 w375", "Open config.ini File").OnEvent("Click", OpenConfig)
MyGui.Add("Text", "x20 y170", "Additional settings are available on the 'Other' tab.")
MyGui.Add("Text", "x20 y190", "If you encounter any issues with the macro, please check the links `nbelow or contact the owner via these buttons.")
MyGui.Add("Button", "x20 y230 w375", "Discord").OnEvent("Click", OpenDiscord)
MyGui.Add("Button", "x20 y260 w375", "Github").OnEvent("Click", OpenGithub)
MyGui.Add("Button", "x20 y290 w375", "Youtube").OnEvent("Click", OpenYoutube)
